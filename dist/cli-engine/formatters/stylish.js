...
var require_text_table = __commonJS({
  "node_modules/eslint/lib/shared/text-table.js"(exports2, module2) {
    "use strict";
...
var table = require_text_table();
function pluralize(word, count) {
  return count === 1 ? word : `${word}s`;
}
module.exports = function(results) {
  let output = "\n", errorCount = 0, warningCount = 0, fixableErrorCount = 0, fixableWarningCount = 0, summaryColor = "yellow";
